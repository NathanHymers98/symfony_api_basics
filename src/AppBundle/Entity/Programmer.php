...
// The @Serializer\ExclusionPolicy("all") tells the serializer: dont serialize any properties by default
/**
 * Programmer
 *
...
class Programmer
{
    ...
    // Since we told the serializer to not serialize any properties of this class by default, we need to add @Serializer\Expose annotation to the properties that we do want to serialize
    /**
     * @var string
     *
